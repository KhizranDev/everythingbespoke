...
<head>
    ...
    <title>Zegna Febric  | Everything Bespoke</title>
            ...
            <div class="row">
                <div class="col-lg-12 portfolio-wrap">
                    <div class="row portfolio-list">
                        ...
                        <?php $myFiles = scandir("images/fabric/pattern/suits-zegna/$query_string"); ?>
                        ...
                        <div class="single-portfolio-item col-lg-3 col-sm-6 all">
                            <div class="portfolio-item" style='background-image: url("images/fabric/pattern/suits-zegna/<?php echo $query_string; ?>/<?php echo $file; ?>");'>
                                <a href="images/fabric/pattern/suits-zegna/<?php echo $query_string; ?>/<?php echo $file; ?>" data-lightbox="roadtrip" data-lightbox="image-1" data-title="Article # <?php echo str_replace(".jpg", "", $file); ?>" class="portfolio-desc">
                                    <img src="images/fabric/pattern/suits-zegna/<?php echo $query_string; ?>/<?php echo $file; ?>" />
                                </a>
                            </div>
