...
<head>
    ...
    <title>Unbranded Shirts Fabric | Everything Bespoke</title>
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content">
                        <div class="breadcrumb__titles">
                            <h2 class="breadcrumb__title">Unbranded Shirts Fabric</h2>
                        </div>
                        <ul class="breadcrumb__list">
                            <li class="breadcrumb__list-active"><a href="index.php">Home</a></li>
                            <li>Unbranded Shirts Fabric</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 portfolio-wrap">
                    <div class="row portfolio-list">
                        <?php $myFolders = scandir("images/fabric/pattern/casual-shirts-unbranded"); ?>
                        ...
                        <?php if ($folder != "." && $folder != ".."): ?>
                            <?php $myFiles = scandir("images/fabric/pattern/casual-shirts-unbranded/$folder");
                                ...
                                foreach ($myFiles as $file) {
                                    ...
                                    if ($ext == "jpg") {
                                        $img_name = "images/fabric/pattern/casual-shirts-unbranded/$folder/$file"; 
                                        break;
                                    }
                                }
                            ?>
                        ...
                        <div class="single-portfolio-item col-lg-3 col-sm-6 all">
                            <div class="portfolio-item" style='background-image: url("<?php echo $img_name; ?>");'>
                                <a href="casual-shirts-list.php?category-name=<?php echo $folder; ?>" class="portfolio-desc">
