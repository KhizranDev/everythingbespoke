...
if (isset($_GET['id'])){
    ...
    $sql = "SELECT id,fullname,isactive FROM tbl_fabric WHERE isactive = 1 AND id = '$fabric_id'";
    $result = $database->query($sql);
    $row = $database->fetch_array($result);
    $fabric_name = $row["fullname"];

    $sql = "SELECT id article_id,fullname,isactive,image_name FROM tbl_article WHERE isactive = 1 AND fabric_id = '$fabric_id'";
    $result = $database->query($sql);
                ...
                <div class="col-lg-12 portfolio-wrap">
                    <div class="row portfolio-list">
                        ...
                        <? while ($row = $database->fetch_assoc($result)){ ?>
                            <? $image_name = ARTICLE_URL.$row["image_name"]; ?>
