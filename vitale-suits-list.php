...
<head>
    ...
    <title>Suits Angelico | Everything Bespoke</title>
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content">
                        <div class="breadcrumb__titles">
                            <h2 class="breadcrumb__title">Suits Angelico</h2>
                        </div>
                        <ul class="breadcrumb__list">
                            <li class="breadcrumb__list-active"><a href="index.php">Home</a></li>
                            <li>Suits Angelico</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 portfolio-wrap">
                    <div class="row portfolio-list">
                        <?php $myFiles = scandir("images/fabric/pattern/suits-angelico"); ?>
                        ...
                        <div class="single-portfolio-item col-lg-3 col-sm-6">
                            <div class="portfolio-item" style='background-image: url("images/fabric/pattern/suits-angelico/<?php echo $file; ?>");'>
                                <a href="images/fabric/pattern/suits-angelico/<?php echo $file; ?>" data-lightbox="roadtrip" data-lightbox="image-1" data-title="Article # <?php echo str_replace(".jpg", "", $file); ?>" class="portfolio-desc">
                                    <img src="images/fabric/pattern/suits-angelico/<?php echo $file; ?>" />
                                </a>
                            </div>
