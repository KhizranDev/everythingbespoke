...
<head>
    ...
    <title>Unbranded | Everything Bespoke</title>
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content">
                        <div class="breadcrumb__titles">
                            <h2 class="breadcrumb__title">Unbranded</h2>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12 portfolio-wrap">
                    <div class="row portfolio-list">
                        <?php $myFiles = scandir("images/fabric/pattern/suits-unbranded"); ?>
                        ...
                        <div class="single-portfolio-item col-lg-3 col-sm-6">
                            <div class="portfolio-item" style='background-image: url("images/fabric/pattern/suits-unbranded/<?php echo $file; ?>");'>
                                <a href="images/fabric/pattern/suits-unbranded/<?php echo $file; ?>" data-lightbox="roadtrip" data-lightbox="image-1" data-title="Article # <?php echo str_replace(".jpg", "", $file); ?>" class="portfolio-desc">
                                    <img src="images/fabric/pattern/suits-unbranded/<?php echo $file; ?>" />
                                </a>
                            </div>
