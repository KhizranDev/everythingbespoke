            ...
            <div class="row">
                <div class="col-lg-12 portfolio-wrap">
                    <div class="row portfolio-list">
                        <?php $myFolders = scandir("images/fabric/pattern/suits-guabello"); ?>
                        ...
                        <?php if ($folder != "." && $folder != ".."): ?>
                            <?php $myFiles = scandir("images/fabric/pattern/suits-guabello/$folder");
                                ...
                                foreach ($myFiles as $file) {
                                    ...
                                    if ($ext == "jpg") {
                                        $img_name = "images/fabric/pattern/suits-guabello/$folder/$file"; 
                                        break;
                                    }
                                }
                            ?>
                        ...
                        <div class="single-portfolio-item col-lg-3 col-sm-6 all">
                            <div class="portfolio-item" style='background-image: url("<?php echo $img_name; ?>");'>
                                <a href="guabello-suits-list.php?category-name=<?php echo $folder; ?>" class="portfolio-desc">
