            ...
            <div class="row">
                <div class="col-lg-12 portfolio-wrap">
                    <div class="row portfolio-list">
                        <?php $myFolders = scandir("images/fabric/guide/suits"); ?>
                        ...
                        <?php if ($folder != "." && $folder != ".."): ?>
                            <?php $myFiles = scandir("images/fabric/guide/suits/$folder");
                                ...
                                foreach ($myFiles as $file) {
                                    ...
                                    if ($ext == "jpg") {
                                        $img_name = "images/fabric/guide/suits/$folder/$file"; 
                                        break;
                                    }
                                }
                            ?>
                        ...
                        <div class="single-portfolio-item col-lg-3 col-sm-6 all">
                            <div class="portfolio-item" style='background-image: url("<?php echo $img_name; ?>");'>
                                <a href="suits-guide-list.php?category-name=<?php echo $folder; ?>" class="portfolio-desc">
