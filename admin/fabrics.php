        ...
        <div class="main-panel">
            ...
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title"> Fabrics </h3>
                ...
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><button type="button" class="btn btn-primary btn-fw" id="btnAdd">Add Fabric</button> </h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" id="frmData" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="txtFabricName">Fabric Name</label>
                                            <input type="text" class="form-control" id="txtFabricName" name="txtFabricName" placeholder="Fabric Name">
                                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '#btnSave', function () {
            ...
            if ($("#txtFabricName").val() == "" || $("#ddlType").val() == 0 || $("#ddlBrand").val() == 0){
                return false;
            }
        ...
        $.ajax({
            ...
            $.each(data, function (index, value) {
                ...
                _html += `<tr>
                            ...
                            <td class="center">
                                <a class="btn btn-info btn-sm btnEdit" id="${value["Id"]}" data-type="${value["TypeId"]}" data-brand="${value["BrandId"]}" data-fabric="${value["FullName"]}" data-active="${value["IsActive"]}" href="javascript:;">
