        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Add Style</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" id="frmData" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="ddlStyleType">Style Type</label>
                                            <select class="js-example-basic-single" id="ddlStyleType" name="ddlStyleType" style="width:100%">
                                                <option value="0">Select</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="txtStyle" name="txtStyle" placeholder="Style Name">
                                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.btnEdit', function () {
            ...
            $.ajax({
                type: "POST",
                url: "include/ajax/action_style.php",
                dataType: "json",
                data: {
                    'dataid'  : DataId,
                ...
                let style_type = data.StyleTypeId
                let style = data.FullName
                let active = data.IsActive == 1 ? true : false

                $('.chkIsActive').prop('checked', active);

                GetType(type,style_type)
        ...
        $(document).on('click', '#btnSave', function () {
            ...
            if ($("#txtStyleTypeName").val() == "" || $("#ddlType").val() == 0){
                return false;
            }
    ...
    function Clear(){
        ...
        $("#ddlStyleType").val(0).trigger('change');
        $("#btnSave").removeAttr('disabled');
    }

    function GetType(type,style_type) {
    ...
    function GetStyleType(type_id,style_type_id) {
        //console.log("style_type_id",style_type_id)
        $.ajax({
            type: "POST",
            url: "../include/ajax/action_dropdown.php",
            dataType: "json",
            ...
            $.each(data, function (index, value) {
                ...
                $('<option>', {
                    value: value["Id"],
                    html: value["FullName"],
                    selected: value["Id"] == style_type_id
