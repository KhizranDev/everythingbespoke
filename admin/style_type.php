        ...
        <div class="main-panel">
            ...
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title"> Style Type </h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Settings</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Style Type</li>
                        </ol>
                    </nav>
                </div>
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><button type="button" class="btn btn-primary btn-fw" id="btnAdd">Add Style Type</button> </h4>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Add Style Type</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" id="frmData" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="txtBrandName">Style Type Name</label>
                                            <input type="text" class="form-control" id="txtStyleTypeName" name="txtStyleTypeName" placeholder="Style Type Name">
                                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.btnEdit', function () {
            ...
            $.ajax({
                type: "POST",
                url: "include/ajax/action_style_type.php",
                dataType: "json",
                data: {
                    'dataid'  : DataId,
                ...
                $("#txtStyleTypeName").val(style_type)
