            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><button type="button" class="btn btn-primary btn-fw" id="btnAdd">Add Catalogue</button> </h4>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterTitle">Add Catalogue</h5>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" id="frmData" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="txtCatalogueName">Catalogue Name</label>
                                            <input type="text" class="form-control" id="txtCatalogueName" name="txtCatalogueName" placeholder="Catalogue Name">
                                        </div>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '#btnSave', function () {
            ...
            if ($("#txtCatalogueName").val() == "" || $("#ddlType").val() == 0){
                return false;
            }
            ...
            $.ajax({
                type: "POST",
                url: "include/ajax/action_catalogue.php",
                async: true,
                contentType: false,
                processData: false,
                cache: false,
    ...
    function GetData(){
        ...
        let CatalogueDir = "<? echo CATALOGUE_URL ?>"
        ...
        $.ajax({
            ...
            $.each(data, function (index, value) {
                ...
                _html += `<tr>
                            ...
                            <td> <img src="${ CatalogueDir + type_name + '/' + value["ImageName"] }" alt="${value["FullName"]}" style="width: 150px; height: auto; border-radius: 0%!important;" /> </td>
                            <td class="center">
                                <a class="btn btn-info btn-sm btnEdit" id="${value["Id"]}" data-type="${value["TypeId"]}" data-catalogue="${value["FullName"]}" data-active="${value["IsActive"]}" href="javascript:;">
