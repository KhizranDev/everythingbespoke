...
ob_start();
require_once SITE_ROOT.'/third_party/PHPMailer/PHPMailerAutoload.php';
...
function SendEmail($to_email,$cc_email='',$subject,$content){
    ...
    $email_host = "mail.digitizinglab.com";
    $smtp_user = "noreply@digitizinglab.com";
    $smtp_pass = "P&cpV8t&B&Ba";
    ...
    try{
        ...
        $mail->setFrom($smtp_user, 'Digitizing Lab - ' . $subject);
